# -*- coding: utf-8 -*-
"""
Created on Wed Oct  2 11:06:26 2024
    ...
    for fila in range(num_filas - 1):
        ...
        for col in range(num_columnas):
            if col in columnas_a_mezclar:
                ...
                nueva_fila[col] = matriz[indice_permutado][col]  # Valor original según índice permutado
            else:
                nueva_fila[col] = matriz[fila + 1][col]  # Mantener valores originales en columnas no mezcladas
